...
if (isset($_POST['tambah'])) {
    ...
    $query = "INSERT INTO siswa (nama_siswa, nis, kelas, jenis_kelamin, tempat_tanggal_lahir, alamat, no_hp, status) VALUES ('$nama_siswa', '$nis', '$kelas', '$jenis_kelamin', '$tempat_tanggal_lahir', '$alamat', '$no_hp', '$status')";
    $result = mysqli_query($conn, $query);

    if ($result) {
        //jika penyimpanan data sukses, maka tampilkan pesan sukses
        ...
        echo "<script type='text/javascript'>alert('Data siswa gagal disimpan! Silakan coba lagi.');</script>";
    }
}
?>